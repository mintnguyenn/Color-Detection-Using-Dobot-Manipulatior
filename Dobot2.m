classdef Dobot2 < handle
    ...
    methods
        function self = Dobot2(base, pose)    
...
%compute the intersection parameter
        ...
        function SetInitialiseDobot(self)
            [self.safetyStatePublisher,self.safetyStateMsg] = rospublisher('/dobot_magician/target_safety_status');
            self.safetyStateMsg.Data = 2;
            send(self.safetyStatePublisher,self.safetyStateMsg);
        end
